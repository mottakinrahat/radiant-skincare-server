...
exports.DHAKA_CITY_THANAS = exports.OUTER_DHAKA_UPAZILAS = void 0;
exports.calculateChargeByName = calculateChargeByName;
exports.OUTER_DHAKA_UPAZILAS = [
    "savar",
    "dhamrai",
    "keraniganj",
    "nawabganj",
 ...
 */
function calculateChargeByName(districtName, upazilaName) {
    ...
    const isOuterUpazila = exports.OUTER_DHAKA_UPAZILAS.some((name) => upa.includes(name));
